# Extract ALL emails with Felix Hamel
...
$attachmentFolder = "C:\Users\Utilisateur\jerome\FELIX-PIECES-JOINTES"
if (-not (Test-Path $attachmentFolder)) {
    New-Item -ItemType Directory -Path $attachmentFolder | Out-Null
}

Write-Host "========================================" -ForegroundColor Magenta
Write-Host "  EXTRACTION EMAILS FELIX HAMEL" -ForegroundColor Magenta
Write-Host "========================================" -ForegroundColor Magenta

# Get all Felix emails (both email addresses)
$allMsgs = @()
$pageToken = $null
do {
    $query = "from:felixhamel1991@gmail.com OR to:felixhamel1991@gmail.com OR cc:felixhamel1991@gmail.com OR from:felixhamel0902@gmail.com OR to:felixhamel0902@gmail.com OR cc:felixhamel0902@gmail.com"
...
$output = @()
$output += "============================================"
$output += "EMAILS FELIX HAMEL AVEC PIECES JOINTES"
...
# Save emails
$outputFile = "C:\Users\Utilisateur\jerome\FELIX-TOUS-EMAILS.txt"
$output | Out-File $outputFile -Encoding UTF8

# Save attachment list
$attachmentListFile = "C:\Users\Utilisateur\jerome\FELIX-LISTE-PIECES-JOINTES.csv"
$attachmentList | Export-Csv $attachmentListFile -NoTypeInformation -Encoding UTF8

Write-Host "`n========================================" -ForegroundColor Green
Write-Host "EXTRACTION FELIX COMPLETE!" -ForegroundColor Green

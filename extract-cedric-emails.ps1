# Extract ALL emails with Cedric Leboeuf
...
$attachmentFolder = "C:\Users\Utilisateur\jerome\CEDRIC-PIECES-JOINTES"
if (-not (Test-Path $attachmentFolder)) {
    New-Item -ItemType Directory -Path $attachmentFolder | Out-Null
}

Write-Host "========================================" -ForegroundColor Magenta
Write-Host "  EXTRACTION EMAILS CEDRIC LEBOEUF" -ForegroundColor Magenta
Write-Host "  (info@cedricleboeuf.com + cedric2177@gmail.com)" -ForegroundColor Magenta
Write-Host "========================================" -ForegroundColor Magenta

# Get all Cedric emails (both email addresses)
$allMsgs = @()
$pageToken = $null
do {
    $query = "from:info@cedricleboeuf.com OR to:info@cedricleboeuf.com OR cc:info@cedricleboeuf.com OR from:cedric2177@gmail.com OR to:cedric2177@gmail.com OR cc:cedric2177@gmail.com"
...
$output = @()
$output += "============================================"
$output += "EMAILS CEDRIC LEBOEUF AVEC PIECES JOINTES"
$output += "(info@cedricleboeuf.com + cedric2177@gmail.com)"
...
# Save emails
$outputFile = "C:\Users\Utilisateur\jerome\CEDRIC-TOUS-EMAILS.txt"
$output | Out-File $outputFile -Encoding UTF8

# Save attachment list
$attachmentListFile = "C:\Users\Utilisateur\jerome\CEDRIC-LISTE-PIECES-JOINTES.csv"
$attachmentList | Export-Csv $attachmentListFile -NoTypeInformation -Encoding UTF8

Write-Host "`n========================================" -ForegroundColor Green
Write-Host "EXTRACTION CEDRIC COMPLETE!" -ForegroundColor Green

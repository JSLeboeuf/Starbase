# Extract ALL emails with RH Support from Gmail
...
$attachmentFolder = "C:\Users\Utilisateur\jerome\RHSUPPORT-PIECES-JOINTES"
if (-not (Test-Path $attachmentFolder)) {
    New-Item -ItemType Directory -Path $attachmentFolder | Out-Null
}

Write-Host "========================================" -ForegroundColor Magenta
Write-Host "  EXTRACTION EMAILS RH SUPPORT" -ForegroundColor Magenta
Write-Host "  (*@rhsupport.ca)" -ForegroundColor Magenta
Write-Host "========================================" -ForegroundColor Magenta

# Get all RH Support emails
$allMsgs = @()
$pageToken = $null
do {
    $query = "from:rhsupport.ca OR to:rhsupport.ca OR cc:rhsupport.ca"
...
# Save output
$outputFile = "C:\Users\Utilisateur\jerome\RHSUPPORT-TOUS-EMAILS.txt"
$output | Out-File $outputFile -Encoding UTF8

# Save attachment list
$csvFile = "C:\Users\Utilisateur\jerome\RHSUPPORT-LISTE-PIECES-JOINTES.csv"
